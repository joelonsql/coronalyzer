...
fhm <- data.frame(
    country     = "Sweden FHM",
    cases      = cumsum(c(1,0,1,1,2,2,1,6,7,10,7,12,11,20,25,29,32,35,38,44,45,51,67,79,68,81,90,78,102,75,75,74,79,63,60,56,61,23,9,1+19))
)
